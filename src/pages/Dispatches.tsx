                              ...
                              <div className="dispatch-detail-grid" style={{ gap: '1.25rem' }}>
                                ...
                                <div style={{ 
                                  ...
                                  <div style={{ 
                                    ...
                                    {/* Left Column: Location Information (지역 정보) */}
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                                      <div style={{ 
                                        ...
                                        <div style={{ fontSize: '0.82rem', fontWeight: 800, color: 'var(--text-primary)', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.45rem', marginBottom: '0.15rem' }}>
                                          📍 지역 정보
                                        </div>
                                        ...
                                        <div style={{ borderBottom: '1px dashed var(--border-color)', margin: '0.15rem 0' }} />

                                        {/* Waypoints Block */}
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <span style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--text-tertiary)' }}>경유지 정보 및 관리</span>
                                                ...
                                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem', alignItems: 'center' }}>
                                                  {dispatch.waypoints.map((wp: string, wIdx: number) => (
                                                    <div key={wIdx} style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                                                      ...
                                                      <span style={{ fontSize: '0.78rem', fontWeight: 600, color: 'var(--text-primary)', backgroundColor: 'var(--bg-primary)', padding: '0.15rem 0.4rem', borderRadius: '4px', border: '1px solid var(--border-color)', whiteSpace: 'nowrap' }}>
                                                        {wp}
                                                      </span>
                                                    </div>
                                                  ))}
                                  ...
                                  {/* Right Column: Billing & Settle details, Cargo Type, Memo */}
                                  <div style={{ 
                                    display: 'flex', 
                                    flexDirection: 'column', 
                                    gap: '0.85rem'
                                  }}>
                                    <div style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)', padding: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                                      <div>
